  ...
  return (
    <>
      ...
      <main className="flex flex-col gap-24">
        <section>
          <div className="container flex items-center flex-wrap-reverse md:flex-nowrap md:mt-20">
        ...
        <section>
          <div className="container flex items-center justify-center text-center flex-wrap-reverse gap-5 md:flex-nowrap md:text-left">
            <div className="prose prose-headings:text-dark-blue prose-headings:mb-5">
              ...
              <p>
                Por meio de parcerias, buscamos apoiar jovens em regiões
                remotas, criar campanhas de conscientização e desenvolver
                projetos em locais públicos, a fim de difundir conhecimento
                sobre saúde mental e gerar impacto positivo.
              </p>
              <p>
                Assim, em conexão com organizações civis, sociais e
                empresariais, procuramos criar uma rede de apoio para que cada
                vez mais pessoas tenham auxílio e incentivo para alcançarem seu
                melhor potencial.
              </p>
            </div>
            <Image
